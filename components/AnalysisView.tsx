              ...
              {songInputIndex === idx && (
                <div className="mb-4 flex gap-2 animate-in slide-in-from-top-2 duration-300">
                  <input
                    ...
                    placeholder="참고할 곡 제목 입력..."
                    className="flex-1 bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-xl px-4 py-2 text-sm text-slate-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-blue-500/50"
                  />
                  <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {analysis.sources.map((source, idx) => (
              <a 
                ...
                className="group p-4 bg-slate-50 dark:bg-zinc-900/40 hover:bg-white dark:hover:bg-zinc-800/60 border border-slate-200 dark:border-zinc-800 hover:border-blue-300 dark:hover:border-zinc-700 rounded-xl transition-all shadow-sm hover:shadow-md dark:shadow-none"
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white dark:bg-zinc-800 rounded-lg group-hover:bg-blue-50 dark:group-hover:bg-zinc-700 transition-colors shadow-sm">
